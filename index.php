    ...
    <nav class="mobile-nav">
      <ul class="mobile-nav__list">
        <li class="mobile-nav__item">
          <a class="mobile-nav__link" href="<?php echo home_url('/'); ?>">Студія</a>
        </li>
        <li class="mobile-nav__item">
      ...
      <ul class="examples">
        <li class="examples__card">
          <div class="thumb">
            ...
            <picture>
              <source srcset="<?php echo get_template_directory_uri(); ?>/images/box1.jpg 1x, ./images/box1@x2.jpg 2x"
        ...
        <li class="examples__card">
          <div class="thumb">
            ...
            <picture>
              <source srcset="<?php echo get_template_directory_uri(); ?>/images/box2.jpg 1x, ./images/box2@x2.jpg 2x"
                sizes="370px" type="image/jpeg" />
        ...
        <li class="examples__card">
          <div class="thumb">
            ...
            <picture>
              <source srcset="<?php echo get_template_directory_uri(); ?>/images/box3.jpg 1x, ./images/box3@x2.jpg 2x"
                sizes="370px" type="image/jpeg" />
      ...
      <ul class="members">
        <li class="members__item">
          <picture>
            ...
            <source srcset="<?php echo get_template_directory_uri(); ?>/images/face1.jpg 1x, ./images/face1@x2.jpg 2x"
        ...
        <li class="members__item">
          <picture>
            ...
            <source
              ...
              media="(min-width: 768px)" type="image/jpeg" />
            <source srcset="<?php echo get_template_directory_uri(); ?>/images/face2.jpg 1x, ./images/face2@x2.jpg 2x"
              media="(min-width: 1200px)" type="image/jpeg" />
        ...
        <li class="members__item">
          <picture>
            ...
            <source
              ...
              media="(min-width: 768px)" type="image/jpeg" />
            <source srcset="<?php echo get_template_directory_uri(); ?>/images/face3.jpg 1x, ./images/face3@x2.jpg 2x"
              media="(min-width: 1200px)" type="image/jpeg" />
        ...
        <li class="members__item">
          <picture>
            ...
            <source
              ...
              media="(min-width: 768px)" type="image/jpeg" />
            <source srcset="<?php echo get_template_directory_uri(); ?>/images/face4.jpg 1x, ./images/face4@x2.jpg 2x"
              media="(min-width: 1200px)" type="image/jpeg" />
